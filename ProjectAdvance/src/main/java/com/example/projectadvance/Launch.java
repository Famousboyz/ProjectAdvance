package com.example.projectadvance;
...
public class Launch extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        try {
            Image icon = new Image(this.getClass().getResource("picture/mountain.jpg").toExternalForm());
            this.stage.getIcons().add(icon);
        }catch (Exception e){
            System.out.println("Icon file not found");
        }

        this.stage.setTitle("Fucking hard project");
